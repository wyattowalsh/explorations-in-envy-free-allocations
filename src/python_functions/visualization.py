# This file holds the visualization functions used throughout the course of Explorations in Envy-Free Allocations
...
def tabular_statistics(rel_path_to_results,
    ...
    if cash:
        results.columns = columns.append('Subsidy Amount')
...
def parallel_categories(data, type_of, name=None, save=False):
    fig = px.parallel_categories(
        ...
        title="Parallel Categories Plot for {}".format(type_of),
        width=1000,
        height=500)
